...
import ammonite.compiler.iface.{Compiler as ICompiler, CompilerBuilder as ICompilerBuilder, CompilerLifecycleManager as ICompilerLifecycleManager, Preprocessor as IPreprocessor, *}
...
import dotty.tools.dotc.config.{CompilerCommand, JavaPlatform}
...
import dotty.tools.dotc.core.{CompilationUnitInfo, Flags, MacroClassLoader, Mode}
...
import dotty.tools.dotc.{CompilationUnit, Run, ScalacCommand, classpath, report, reporting, semanticdb, Compiler as DottyCompiler}
