...
object Filter {
   ...
   */
  def simple(prefixes: Strings)(f: (Vector[Char], Int, TermInfo) => (Vector[Char], Int))(implicit
      l: sourcecode.Line,
  ...
  )(action: TermState => TermAction = x => x)(implicit
      i: sourcecode.Enclosing,
   ...
   */
  def merge(pfs: Filter*)(implicit i: sourcecode.Enclosing) = new Filter {
