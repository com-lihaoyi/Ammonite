...
object Storage {
  final class InMemory extends Storage {
    var predef = ""
    var sharedPredef = ""
  ...
  //       )
  //       write(
  //         codeCacheDir / "imports.json",
  //         upickle.default.write(imports, indent = 4)
  //       )
  //       write(
  //         codeCacheDir / "importTrees.json",
  //         upickle.default.write(importTreesList, indent = 4)
  //       )
  ...
  //       val impTrees =
  //         readJson[Seq[ImportTree]](codeCacheDir / "importTrees.json")
  ...
  //     Try {
  //       val data = classFiles.map {
  //         case file =>
  //           val className =
  //             (file relativeTo cacheDir).toString.stripSuffix(".class")
