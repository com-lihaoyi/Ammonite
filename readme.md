...
- Create a new release on [https://github.com/lihaoyi/Ammonite/releases] and upload the two executables for 2.11.7 and 2.10.5, as well as the `shell/src/main/resources/ammonite/shell/example-predef.scala` file.
